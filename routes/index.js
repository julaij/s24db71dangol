...
router.get('/', function (req, res) {
  res.render('index', { title: 'Artists App', user: req.user });
});

router.get('/register', function (req, res) {
  res.render('register', { title: 'Artists App Registration' });
});
...
router.get('/login', function (req, res) {
  res.render('login', { title: 'Artists App Login', user: req.user });
});
